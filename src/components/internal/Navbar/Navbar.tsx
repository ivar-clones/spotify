...
export const Navbar = () => {
  const { logout, login, client } = useContext(SpotifyContext);
  ...
  return (
    <div className="flex flex-row justify-end h-16 items-center border-b px-2">
      {!client ? (
        <Button onClick={login} className="bg-green-700 rounded-full px-2">
          <svg
